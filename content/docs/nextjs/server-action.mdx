...
Server Actions သည် Next.js 14 မှာ အသစ်ထပ်မံထည့်သွင်းလာသော အရေးကြီးဆုံး feature များထဲမှ တစ်ခုဖြစ်ပြီး
၊ Component ထဲကနေ တိုက်ရိုက် Server ကိုပြုပြင်နိုင်စေသော feature ဖြစ်ပါတယ်။
ဒါကြောင့် ကိုယ်ပိုင် API server တည်ဆောက်စရာမလိုတော့ပဲ Backend logic တွေကို Component မှာတိုက်ရိုက်ရေးနိုင်ပါတယ်။

```tsx
"use server";
```

မှတ်ချက် – ဒီ server actions တွေဟာ SSR (Server-side Rendering) တွေနဲ့မတူပါဘူး။
Form action အနေနဲ့သုံးတဲ့အခါမှာ browser ကနေ တိုက်ရိုက် server function ကို call လုပ်နိုင်ပါတယ်။
...
- use server ကို function ထဲမှာရေးရပါမယ်။
